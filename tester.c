...
void MoveServo()
{
	servo[servoLift] = servoMoveRange; //Flip the block out.
	while (ServoValue[servoLift] < servoMoveRange)
	{
		wait1Msec(20);
	}

	servo[servoLift] = ServoValue[servoLift] - servoMoveRange; //Move back to the starting position.
}
