...
//Original display code for color sensor
...
// Simplified display code for color sensor
	nxtDisplayString(3, "_color: %d", _color);
	nxtDisplayString(4, "red:    %d", red);
	nxtDisplayString(5, "green:  %d", green);
	nxtDisplayString(6, "blue:   %d",blue);
	//EndTimeSlice();
}
